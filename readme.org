...
- =It still needs some adaptation an rewriting for the specific model
- =Especially this Readme needs some rewriting
- =I only updated and added some kexts, and updated Clover.
- =With more time on my hands I will try to look into the DSDTs, but for the moment Bavariancakes are working fine.
